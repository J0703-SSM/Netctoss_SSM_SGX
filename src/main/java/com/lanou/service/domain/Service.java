...
public class Service {
    ...
    public Service(Integer service_id, Integer account_id, String unix_host, String os_username, String login_passwd, String status, Timestamp create_date, Timestamp pause_date, Timestamp close_date, Integer cost_id) {
